<?php /* Smarty version 2.6.27, created on 2017-09-22 09:05:49
         compiled from basis/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/index.tpl', 85, false),array('modifier', 'h', 'basis/index.tpl', 91, false),array('modifier', 'sfGetErrorColor', 'basis/index.tpl', 172, false),array('function', 'html_options', 'basis/index.tpl', 123, false),array('function', 'html_checkboxes', 'basis/index.tpl', 184, false),)), $this); ?>
...
;<?php endif; ?>" id="longitude"><a class="btn-normal" href="javascript:;" name="codeAddress" id="codeAddress" onclick="">所在地より自動取得</a>
            ...
            </tr></table><input type="hidden" name="image_key" value="" />
    ...
    <table>
        <tr>
            ...
            <td>
                <span class="attention"> <?php echo ((is_array($_tmp=$this->_tpl_vars['pdfLogoErr'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
 </span>
                <div>
                    <img src = "<?php echo ((is_array($_tmp=$this->_tpl_vars['path_to_PDF_logo'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" />
                    <a href="javascript:;" name="btn" onclick="fnModeSubmit('reset_logo', 'image_key', '<?php echo ((is_array($_tmp=$this->_tpl_vars['logoKey'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">[画像のリセット]</a>
                </div>
                <div>
                    推奨ロゴサイズ 180px × 30px
                </div>
                <div>
                    ...
                    <a class="btn-normal" href="javascript:;" onclick="fnModeSubmit('upload_logo', 'image_key', '<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
');"><span class="btn-next">アップロード</span></a>
                </div>
            </td>
        </tr>
    </table>
