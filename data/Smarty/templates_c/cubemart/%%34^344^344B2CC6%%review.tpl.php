<?php /* Smarty version 2.6.27, created on 2017-09-22 16:16:29
         compiled from products/review.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/review.tpl', 34, false),array('modifier', 'h', 'products/review.tpl', 36, false),array('modifier', 'sfGetErrorColor', 'products/review.tpl', 46, false),array('function', 'html_options', 'products/review.tpl', 65, false),)), $this); ?>
...
" />
        <table class="table table-bordered ui-table" summary="お客様の声書き込み">
            <col width="30%" />
            <col width="70%" />
            <tr>
                <th>商品名</th>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
        ...
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <input type="submit" class="btn btn-main btn-styled" value="確認ページへ" name="conf" id="conf" />
                                    </li>
            </ul>
        </div>
    </form>
