<?php /* Smarty version 2.6.27, created on 2017-09-25 15:02:43
         compiled from /home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl', 25, false),array('modifier', 'h', '/home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl', 25, false),array('modifier', 'default', '/home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl', 42, false),array('modifier', 'sfGetErrorColor', '/home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl', 42, false),array('function', 'html_options', '/home/www.yojyo.jp/html/../data/Smarty/templates/cubemart/contact/index.tpl', 76, false),)), $this); ?>
...
<div id="undercolumn">
    ...
    <div id="undercolumn_contact" class="margin-section">

        <p>内容によっては回答をさしあげるのにお時間をいただくこともございます。<br />
        また、休業日は翌営業日以降の対応となりますのでご了承ください。</p>

        <form name="form1" enctype="multipart/form-data" id="form1" class="ui-form form-contact" method="post" action="?">
...
', 'zip01', 'zip02', 'pref', 'addr01');" class="btn btn-default btn-sm">住所自動入力</a>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['addr02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
                        ...
                        <select name="pref" class="margin-content" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['pref'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
">
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['contents']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        <input type="submit" class="btn btn-main btn-styled" value="確認ページへ" name="confirm" />
                                            </li>
                </ul>
            </div>
