...
<div id="undercolumn">
    ...
    <div id="undercolumn_contact" class="margin-section">
        ...
        <form name="form1" id="form1" class="ui-form form-contact" method="post" action="?">
 ...
 <option value="その他">その他</option>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="zipimg">
                            <a href="javascript:eccube.getAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'zip01', 'zip02', 'pref', 'addr01');" class="btn btn-default btn-sm">住所自動入力</a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="pref" class="margin-content" style="<!--{$arrErr.pref|sfGetErrorColor}-->">
