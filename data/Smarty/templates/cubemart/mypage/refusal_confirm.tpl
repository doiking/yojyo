...
<div id="mypagecolumn">
    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <div id="mycontents_area" class="margin-section">
            <div class="ui-headline-ui-section-title">
                ...
                <div class="message_area">
                    <div class="btn_area">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="./refusal.php" class="btn btn-main btn-styled">いいえ、退会しません</a>
                                <!--{* 
                            ...
                            <li>
                                <input type="submit" class="btn btn-default btn-styled" value="はい、退会します" name="refuse_do" id="refuse_do" />
                                <!--{* 
                                * ボタンに画像を使うときはコメントアウトを解除
