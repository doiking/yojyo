    ...
    <div id="mycontents_area" class="margin-section">
        ...
        <form name="form1" id="form1" class="ui-form form-contact" method="post" action="?">
            ...
            <!--{foreach from=$arrForm key=key item=item}-->
                ...
                <!--{/if}-->
            <!--{/foreach}-->
            <table summary=" " class="delivname table table-bordered ui-table">
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        <a href="?" onclick="eccube.setModeAndSubmit('return', '', ''); return false;" class="btn btn-default btn-styled">戻る</a>
                        <!--{* 
                    ...
                    <li>
                        <input type="submit" class="btn btn-main btn-styled" value="完了ページへ" name="complete" id="complete" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
