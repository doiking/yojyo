...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area" class="margin-section">
        <div class="ui-headline section-title">
            <h3 class="title"><!--{$tpl_subtitle|h}--></h3>
        </div>
        <div class="mycondition_area margin-section clearfix">
            <p>
            ...
            <form action="order.php" method="post">
                ...
                <p class="btn">
                    ...
                    <input type="submit" class="btn btn-default btn-styled" value="この購入内容で再注文する" name="submit" />
                    <!--{* 
        ...
        <div class="table-responsive">
            <table class="table table-bordered ui-table" summary="購入商品詳細">
                <col width="15%" />
                <col width="25%" />
                <col width="20%" />
                <col width="15%" />
        ...
        <!--{if $smarty.const.USE_POINT !== false}-->
            <table summary="使用ポイント" class="table table-bordered ui-table">
                <col width="30%" />
                <col width="70%" />
                <tr>
        ...
        <!--{foreach item=shippingItem name=shippingItem from=$arrShipping}-->
            ...
            <!--{if $isMultiple}-->
                <table class="table table-bordered ui-table" summary="お届け内容確認">
                    <col width="30%" />
                    <col width="40%" />
                    <col width="20%" />
                    <col width="10%" />
            ...
            <!--{/if}-->
            <table summary="お届け先" class="delivname table table-bordered ui-table">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                    <tr>
        ...
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <a href="./<!--{$smarty.const.DIR_INDEX_PATH}-->" class="btn btn-default btn-styled">戻る</a>
                    <!--{* 
                    * ボタンに画像を使うときはコメントアウトを解除
