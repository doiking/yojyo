...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area" class="margin-section">
        ...
        <!--{if $tpl_linemax < $smarty.const.DELIV_ADDR_MAX}-->
            ...
            <!--{if $tpl_login}-->
                <p class="add_address">
                    <a href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php" onclick="eccube.openWindow('./delivery_addr.php','delivadd','600','640',{menubar:'no'}); return false;" target="_blank" class="btn btn-default btn-styled">新しいお届け先を追加</a>
                    <!--{* 
        ...
        <!--{if $tpl_linemax > 0}-->
            <form name="form1" id="form1" method="post" action="?" >
                ...
                <table class="table table-bordered ui-table" summary="お届け先">
                <col width="5%" />
                <col width="25%" />
                <col width="50%" />
                <col width="10%" />
