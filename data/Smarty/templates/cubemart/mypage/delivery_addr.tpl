...
<div id="window_area">
    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <table class="table table-bordred ui-table" summary="お届け先登録">
            <!--{include file="`$smarty.const.TEMPLATE_REALDIR`frontparts/form_personal_input.tpl" flgFields=1 emailMobile=false prefix=""}-->
        </table>
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <a class="btn btn-main btn-styled btn-sm" href="javascript:" onclick="eccube.setValueAndSubmit('form1', 'mode', 'edit'); return false;">登録する</a>
                    <!--{*
