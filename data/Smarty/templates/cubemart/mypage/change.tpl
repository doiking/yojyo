...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area" class="margin-section">
        ...
        <form name="form1" id="form1" class="ui-form form-contact" method="post" action="?">
            ...
            <table summary="会員登録内容変更 " class="delivname table table-bordered ui-table">
                <!--{include file="`$smarty.const.TEMPLATE_REALDIR`frontparts/form_personal_input.tpl" flgFields=3 emailMobile=true prefix=""}-->
            </table>
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        <input type="submit" class="btn btn-main btn-styled" value="確認ページへ" name="refusal" id="refusal" />
                        <!--{* 
