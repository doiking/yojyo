                    ...
                    <div class="col-sm-4 col-left-fit">
                        <div class="listphoto list-image">
                            ...
                            <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->">
                                <img src="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$arrProduct.main_list_image|sfNoImageMainList|h}-->" alt="<!--{$arrProduct.name|h}-->" class="picture img-responsive" /></a>
                        </div>
                    </div>
                                    ...
                                    <div class="cartin">
                                        ...
                                        <div class="cartin_btn">
                                            ...
                                            <div id="cartbtn_default_<!--{$id}-->">
                                                <input type="submit" id="cart<!--{$id}-->" value="カゴに入れる" onclick="fnInCart(this.form); return false;" class="btn btn-cart btn-styled" />
                                                <!--{*
