    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <input type="submit" onclick="mode.value='return';" class="btn btn-default btn-styled" value="戻る" name="back" id="back" />
                    <!--{* 
                    * ボタンに画像を使うときはコメントアウトを解除
                    * <input type="image" onclick="mode.value='return';" class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_back.jpg" alt="戻る" name="back" id="back" />
                    *}-->
                </li>
                <li>
                    <input type="submit" class="btn btn-main btn-styled" value="送信" name="send" id="send" />
                    <!--{* 
                    * ボタンに画像を使うときはコメントアウトを解除
