...
<div id="undercolumn">
    <div id="undercolumn_customer" class="margin-section">
        <p class="flow_area">
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <table class="table table-bordered ui-table" summary=" ">
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <!--{if $smarty.const.USE_MULTIPLE_SHIPPING !== false}-->
                        <li>
                            <input type="submit" class="btn btn-default btn-styled" value="上記のお届け先のみに送る" name="singular" id="singular" />
                            <!--{* 
                        ...
                        <li>
                            <a href="javascript:;" onclick="eccube.setModeAndSubmit('multiple', '', ''); return false" class="btn btn-default btn-styled">複数のお届け先に送る</a>
                            <!--{* 
                            * ボタンに画像を使うときはコメントアウトを解除
                    ...
                    <!--{else}-->
                        <li>
                            <input type="submit" class="btn btn-main btn-styled" value="次へ" name="singular" id="singular" />
                            <!--{* 
                            * ボタンに画像を使うときはコメントアウトを解除
