...
<div id="undercolumn">
    <div id="undercolumn_shopping" class="margin-section">
        ...
        <div id="address_area" class="clearfix">
            ...
            <!--{if $smarty.const.USE_MULTIPLE_SHIPPING !== false}-->
                <div class="add_multiple">
                    ...
                    <a href="javascript:;" onclick="eccube.setModeAndSubmit('multiple', '', ''); return false" class="btn btn-default btn-styled">お届け先を複数指定する</a>
                    <!--{* 
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <!--{/if}-->
            <table class="table table-bordered ui-table" summary="お届け先の指定">
                <col width="10%" />
                <col width="20%" />
                <col width="50%" />
                <col width="10%" />
