        ...
        <form name="form1" id="form1" method="post" action="?">
                ...
                <div class="delivdate top">
                    ...
                    <p>
                        ...
                        <!--{if !$arrDelivDate}-->
                            ご指定頂けません。
                        <!--{else}-->
                            <select name="<!--{$key}-->" id="<!--{$key}-->" class="form-control input-sm" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        <a href="?mode=return" class="btn btn-default btn-styled">戻る</a>
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
                        * <a href="?mode=return">
                            <img class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_back.jpg" alt="戻る" border="0" name="back03" id="back03" />
                        </a>
                        *}-->
                    </li>
                    <li>
                        <input type="submit" class="btn btn-main btn-styled" value="次へ" name="next" id="next" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
