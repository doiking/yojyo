        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    <li>
                        <a href="./payment.php" class="btn btn-default btn-styled">戻る</a>
                        <!--{* 
                        ...
                        *}-->
                        ...
                        <!--{if $use_module}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main btn-styled" value="次へ" name="next-top" id="next-top" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
                        ...
                        *}-->
                        ...
                        <!--{else}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main btn-styled" value="ご注文完了ページへ" name="next-top" id="next-top" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
            ...
            <table class="table table-bordered ui-table" summary="ご注文内容確認">
                <col width="10%" />
                <col width="40%" />
                <col width="20%" />
                <col width="10%" />
            ...
            <!--{if $tpl_login == 1 && $smarty.const.USE_POINT !== false}-->
                <table summary="ポイント確認" class="delivname table table-bordered ui-table">
                <col width="30%" />
                <col width="70%" />
                    <tr>
            ...
            <table summary="ご注文者" class="customer table table-bordered ui-table">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                    <tr>
            ...
            <!--{foreach item=shippingItem from=$arrShipping name=shippingItem}-->
                ...
                <table summary="お届け先確認" class="delivname table table-bordered ui-table">
                    <col width="30%" />
                    <col width="70%" />
                    <tbody>
                        <tr>
            ...
            <table summary="配送方法・お支払方法・その他お問い合わせ" class="delivname table table-bordered ui-table">
                <col width="30%" />
                <col width="70%" />
                <tbody>
                <tr>
            ...
            <div class="btn_area">
                <ul class="list-inline">
                    ...
                    <!--{if $use_module}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main btn-styled" value="次へ" name="next" id="next" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
                    ...
                    <!--{else}-->
                    <li>
                        <input type="submit" onclick="return fnCheckSubmit();" class="btn btn-main btn-styled" value="ご注文完了ページへ"  name="next" id="next" />
                        <!--{* 
                        * ボタンに画像を使うときはコメントアウトを解除
