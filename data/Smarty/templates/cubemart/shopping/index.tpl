...
<div id="undercolumn">
    <div id="undercolumn_login" class="margin-section">
        ...
        <div class="login_area">
            ...
            <div class="ui-headline ui-content-title">
                <h4 class="title">会員登録をする</h4>
            </div>
            ...
            <div class="inputbox">
                <div class="btn_area">
                    <ul class="list-inline">
                        <li>
                            <a href="<!--{$smarty.const.ROOT_URLPATH}-->entry/kiyaku.php" class="btn btn-main btn-styled">会員登録をする</a>
                            <!--{* 
                            * ボタンに画像を使うときはコメントアウトを解除
            ...
            <div class="ui-headline ui-content-title">
                <h4 class="title">会員登録をせずに購入手続きへ進む</h4>
            </div>
            ...
            <form name="member_form2" id="member_form2" method="post" action="?">
                ...
                <div class="inputbox">
                    <div class="btn_area">
                        <ul class="list-inline">
                            <li>
                                <input type="submit" class="btn btn-main btn-styled" value="購入手続きへ" name="buystep" id="buystep" />
                                <!--{* 
                                * ボタンに画像を使うときはコメントアウトを解除
