    ...
    <form action="?" method="post" name="form1">
        ...
        <div class="btn_area">
            <ul class="list-inline">
                <li>
                    <a href="javascript:window.close()" class="btn btn-default btn-styled">閉じる</a>
                    <!--{* 
                    * ボタンに画像を使うときはコメントアウトを解除
                    * <a href="javascript:window.close()"><img class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_close.jpg" alt="閉じる" /></a>
                    *}-->
                </li>
            </ul>
        </div>
