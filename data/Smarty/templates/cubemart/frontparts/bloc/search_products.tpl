        ...
        <div id="search_area">
            <div class="ui-headline section-title">
                <h2 class="title">検索条件
                    ...
                    * <img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_search.gif" alt="検索条件" />
                    *}-->
                </h2>
            </div>
            <div class="block_body ui-section-body padding-box-sm">
                <!--検索フォーム-->
                <form name="search_form" id="search_form" method="get" action="<!--{$smarty.const.ROOT_URLPATH}-->products/list.php" class="ui-form">
                    ...
                    <p class="btn">
                        <input type="submit" class="btn btn-border btn-styled btn-main btn-sm" value="検索" name="search" />
                        <!--{*
