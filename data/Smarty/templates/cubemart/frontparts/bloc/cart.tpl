    ...
    <div class="block_outer ui-section margin-section-sm">
        <div id="cart_area">
            <div class="ui-headline section-title">
                <h2 class="cart title">カゴの中
                    <!--{*
                    * タイトルに画像を使うときはコメントアウトを解除
                    * <img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_cart.gif" alt="現在のカゴの中" />
                    *}-->
                </h2>
            </div>
            <div class="block_body ui-section-body padding-box-sm">
                ...
                <div class="btn">
                    <a href="<!--{$smarty.const.CART_URL}-->" class="btn btn-border btn-styled btn-main btn-sm">カゴの中を見る</a>
                    <!--{*
