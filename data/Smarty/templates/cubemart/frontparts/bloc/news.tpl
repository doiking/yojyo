        ...
        <div id="news_area">
            <div class="ui-headline section-title">
                <h2 class="title">新着情報
                    ...
                    * <img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_news.png" alt="新着情報" />
                    *}-->
            ...
            <div class="block_body ui-list list-news list-scroll">
                <div class="news_contents">
                    <!--{section name=data loop=$arrNews}-->
                    <!--{assign var="date_array" value="-"|explode:$arrNews[data].cast_news_date}-->
                    <dl class="newslist list-body">
                        <dt class="date"><!--{$date_array[0]}-->年<!--{$date_array[1]}-->月<!--{$date_array[2]}-->日</dt>
                        <dt class="ui-headline list-title">
                            <a class="title"
