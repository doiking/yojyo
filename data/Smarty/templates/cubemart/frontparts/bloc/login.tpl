    ...
    <div class="block_outer ui-section margin-section-sm">
        <div id="login_area">
            ...
            <div class="ui-section-body padding-box-sm">
                <form name="login_form" id="login_form" class="ui-form" method="post" action="<!--{$smarty.const.HTTPS_URL}-->frontparts/login_check.php"<!--{if $tpl_login}--> onsubmit="return eccube.checkLoginFormInputted('login_form')"<!--{/if}-->>
                    ...
                    <div class="block_body">
                        <!--{if $tpl_login}-->
                            ...
                            <!--{if !$tpl_disable_logout}-->
                                <p class="btn">
                                    <input type="submit" class="btn btn-border btn-styled btn-main btn-sm" onclick="eccube.fnFormModeSubmit('login_form', 'logout', '', ''); return false;" value="ログアウト" />
                                    <!--{*
                        ...
                        <!--{else}-->
                            ...
                            <p class="btn">
                                <input type="submit" class="btn btn-border btn-styled btn-main btn-sm" value="ログイン" />
                                <!--{*
                                * ボタンに画像を使うときはコメントアウトを解除
