...
<!--{strip}-->
    ...
    <tr>
        ...
        <td>
            ...
            <p class="zipimg">
                <a href="<!--{$smarty.const.ROOT_URLPATH}-->input_zip.php" onclick="eccube.getAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', '<!--{$key1}-->', '<!--{$key2}-->', '<!--{$key3}-->', '<!--{$key4}-->'); return false;" target="_blank" class="btn btn-default btn-styled btn-sm">住所自動入力</a>
    ...
    <!--{if $flgFields > 1}-->
        ...
        <tr>
            ...
            <td>
                ...
                <!--{/if}-->
                <select class="box80" name="<!--{$key1}-->" style="<!--{$errBirth|sfGetErrorColor}-->">
                    <!--{html_options options=$arrYear selected=$arrForm[$key1].value|default:''}-->
                </select>年&nbsp;
                <select class="box60" name="<!--{$key2}-->" style="<!--{$errBirth|sfGetErrorColor}-->">
                    <!--{html_options options=$arrMonth selected=$arrForm[$key2].value|default:''}-->
                </select>月&nbsp;
                <select class="box60" name="<!--{$key3}-->" style="<!--{$errBirth|sfGetErrorColor}-->">
