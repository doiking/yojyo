    ...
    <body class="<!--{$tpl_page_class_name|h}-->">
        ...
        <div class="frame_outer">
            ...
            <!--{if $arrPageLayout.TopNavi|@count > 0}-->
                <div id="topcolumn" class="margin-section-sm">
                    <!--{* ▼上ナビ *}-->
            ...
            <div id="container" class="container">
                ...
                <div class="row">
                    ...
                    <!--{* ▼CENTER COLUMN *}-->
                    <div id="main_column" <!--{**}-->
                        class="ui-content <!--{if $tpl_column_num|h == 2}-->col-sm-9<!--{elseif $tpl_column_num|h == 1}-->col-xs-12<!--{else}-->col-sm-6 col-sm-push-3<!--{/if}-->
                        <!--{if $tpl_column_num == 2}-->
            ...
            <!--{if $arrPageLayout.FooterBottomNavi|@count > 0}-->
                <div id="footerbottomcolumn" class="padding-row">
                    <div class="container">
                        <!--{* ▼上ナビ *}-->
