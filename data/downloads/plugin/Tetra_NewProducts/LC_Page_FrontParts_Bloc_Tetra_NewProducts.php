...
class LC_Page_FrontParts_Bloc_Tetra_NewProducts extends LC_Page_FrontParts_Bloc {
    ...
    public function getList($dispNumber = 0, $pageNumber = 0, $has_deleted = false)
    {
        ...
        // プラグインの設定情報を取得
        $arrPlugin = array();
        $arrPlugin = SC_Plugin_Util_Ex::getPluginByPluginCode("Tetra_NewProducts");
